...
cat(generatePrefix(df_prefix_imce))

```


## orbit-analysis-01 WorkPackage
...
```{r}
source(searchDirectory(4, "omlvision_wrapper.R", (getwd())))

df_keys <- omlvisionDecomposition(omlrepo = omlrepo, 
                                  df_prefix = df_prefix_imce, 
                                  viewname = "orbit-analysis-01-workflow", 
                                  title = "Workflow orbit analysis 01", 
                                  targetConcept = c("project:Process project:WorkPackage"),
                                  targetRelation = "project:isExecutedBy",
                                  nodeColor = "#006994",
                                  nodeTextColor = "white")
